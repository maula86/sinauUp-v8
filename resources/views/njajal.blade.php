...
<!-- Navbar -->
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent mb-5 " color-on-scroll="400">
    <div class="container">
  ...
  <div class="page-header clear-filter" filter-color="blue">
    <div class="page-header-image" style="background-image:url(loginui/assets/img/login.jpg)"></div>
    <div class="content">
      <div class="container">
