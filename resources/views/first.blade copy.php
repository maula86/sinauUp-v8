...
<head>
  ...
  <!-- Plugin CSS -->
  <link href="{{asset("front/vendor/magnific-popup/magnific-popup.css")}}" rel="stylesheet">

  <!-- Theme CSS - Includes Bootstrap -->
  <link href="{{asset("front/css/creative2.css")}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">SINAU</a>
  ...
  <script src="{{asset("front/js/creative.min.js")}}"></script>
